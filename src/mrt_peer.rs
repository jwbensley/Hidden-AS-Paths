/// This module defines the Peer and PeerTable, which are used to represent BGP peers in MRT files.
/// The Peer struct wraps a BgpKit_Peer to allow for serialisation to JSON.
pub mod peer {
    use bgpkit_parser::models::{Asn, Peer as BgpKit_Peer};
