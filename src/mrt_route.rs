...
pub mod route {
    ...
    impl Route {
        ...
        pub fn get_mock(origin: Option<MrtAsPath>) -> Self {
            let as_path = origin.unwrap_or_else(|| MrtAsPath::get_mock(None));
            ...
            Self {
                ...
                communities: StandardCommunities::default(),
            }
        }

        pub fn get_as_path(&self) -> &MrtAsPath {
            &self.as_path
        }
